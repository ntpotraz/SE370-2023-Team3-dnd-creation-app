...
class Job {
    ...
    switch (x) {
      ...
      case 12:
        this.getEquipment().add(new Weapon("Scimitar", "A curved, slashing sword.", 3, 25, "gp",
            new int[] { 1, 6 }, Weapon.WeaponType.MARTIAL_MELEE, Weapon.AttackType.SLASHING, ""));
        break;
      case 13:
  ...
  void Druid(int x, int y) {
    ...
    switch (y) {
      ...
      case 3:
        ...
        break;
      case 4:
        this.getEquipment().add(new Weapon("Handaxe", "A small, versatile axe.", 5, 5, "gp", new int[] { 1, 6 },
            Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.SLASHING, "Light, Thrown (20/60)"));
        break;
      case 5:
        this.getEquipment().add(new Weapon("Javelin", "A light spear designed for throwing.", 2, 5, "sp",
  ...
  void Fighter(int x, int y, int z, int w, int l) {
    ...
    switch (w) {
      case 0:
        ...
        break;
      case 1:
        this.getEquipment().add(new Weapon("Hand Axe", "A small, versatile axe.", 2, 5, "gp", new int[] { 1, 6 },
  ...
  void Monk(int x, int y) {
    ...
    this.getEquipment().add(new Misc("Dart (10)", "A set of 10 small, throwable projectiles.", 0, 5, "cp"));
  }
  ...
  void Ranger(int x, int y, int z, int w) {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      switch (loopCase) {
        ...
        case 11:
          this.getEquipment()
              .add(new Weapon("Unarmed Strike", "A punch, kick, or other simple unarmed attack.", 0, 0, "",
                  new int[] { 1, 1 }, Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.BLUDGEONING, ""));
          break;
        case 12:
          this.getEquipment().add(new Weapon("Crossbow, Light", "A small, one-handed crossbow.", 5, 25, "gp",
    ...
    this.getEquipment().add(new Weapon("Longbow", "A powerful ranged weapon with great accuracy.", 2, 50, "gp",
        ...
        "Ammunition (range 150/600), Heavy, Two-handed"));
    this.getEquipment()
        .add(new Misc("Arrows (20)", "A quiver containing 20 arrows for use with a ranged weapon.", 1, 1, "gp"));
  }
  ...
  void Rogue(int x, int y, int z) {
    ...
    this.getEquipment().add(new Armor("Leather Armor", "Light armor made from tanned animal hides.", 10, 10, "gp", 11,
    ...
    switch (x) {
      case 0:
        this.getEquipment().add(new Weapon("Light Crossbow", "A small, one-handed crossbow.", 5, 25, "gp",
            ...
            "Ammunition (range 80/320), Loading, Two-handed"));
        this.getEquipment()
            .add(new Misc("Bolts (20)", "A quiver containing 20 bolts for use with a ranged weapon.", 1, 1, "gp"));
        break;
      case 1:
        this.getEquipment().add(new Weapon("Club", "A basic wooden club.", 2, 1, "sp",
            new int[] { 1, 4 }, Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.BLUDGEONING, "Light"));
  ...
  void Warlock(int x, int y, int z, int w) {
    ...
    this.getEquipment().add(new Armor("Leather Armor", "Light, flexible armor made from animal hides.", 10, 10, "gp",
        11, ArmorType.LIGHT, false));
  ...
  void Wizard(int x, int y, int z) {
    ...
    this.getEquipment().add(new Misc("Spellbook",
