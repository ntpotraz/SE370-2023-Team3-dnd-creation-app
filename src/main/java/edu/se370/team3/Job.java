...
class Job {
        ...
        void Barbarian() {
                ...
                this.getEquipment().add(new Weapon("Handaxe", "A small, versatile axe.", 2, 5, "gp",
                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.SLASHING,
                                "Light, Thrown (20/60)"));
                ...
                this.getEquipment().add(new Weapon("Greatclub", "A large, heavy wooden club.", 10, 2, "sp",
                                new int[] { 1, 8 }, Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.BLUDGEONING,
                                "Two-handed"));
                ...
                this.getEquipment()
                                .add(new Weapon("Sickle", "A small, curved blade designed for cutting plants.", 2, 1,
                                                "gp",
                                                new int[] { 1, 4 }, Weapon.WeaponType.SIMPLE_MELEE,
                                                Weapon.AttackType.SLASHING, "Light"));

                this.getEquipment().add(new Weapon("Spear", "A simple, versatile weapon.", 3, 1, "gp",
                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.PIERCING,
                                "Thrown (20/60), Versatile (1d8)"));

                this.getEquipment().add(new Weapon("Unarmed Strike", "A punch, kick, or other simple unarmed attack.",
                                0, 0, "",
                ...
                this.getEquipment().add(new Weapon("Shortbow", "A small bow suitable for short-range attacks.", 2, 25,
                                "gp",
                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.PIERCING,
                                "Ammunition (range 80/320), Two-handed"));

                this.getEquipment()
                                .add(new Weapon("Sling", "A simple leather sling for hurling projectiles.", 0, 1, "sp",
                                                new int[] { 1, 4 }, Weapon.WeaponType.SIMPLE_RANGE,
                                                Weapon.AttackType.BLUDGEONING,
                ...
                this.getEquipmentGiven()
                                .add(new Misc("Explorer's pack",
                                                ...
                                                59, 10, "gp"));
                this.getEquipmentGiven()
                                .add(new Weapon("Javelin's (4)", "A light spear designed for throwing.", 8, 20, "sp",
                                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_MELEE,
                                                Weapon.AttackType.PIERCING, "Thrown (30/120)"));
        ...
        void Bard() {
                ...
                this.getEquipment().add(
                                new Misc("Violin", "A stringed musical instrument played with a bow.", 1, 30, "gp"));

                this.getEquipmentGiven()
                                .add(new Armor("Leather Armor", "Light and flexible leather armor.", 10, 10, "gp", 11,
        ...
        void Cleric() {
                ...
                this.getEquipment()
                                .add(new Weapon("Warhammer", "A versatile, two-handed weapon with a heavy metal head.",
                                                2,
                                                15, "gp", new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.BLUDGEONING, ""));

                this.getEquipment().add(
                                new Armor("Leather Armor", "Light and flexible leather armor.", 10, 10, "gp", 11,
                                                ArmorType.LIGHT, true));

                this.getEquipment()
                                .add(new Armor("Scale Mail", "Armor made of overlapping metal scales.", 45, 50, "gp",
                                                14,
                                                ArmorType.MEDIUM, false));

                this.getEquipment()
                                .add(new Armor("Chain Mail", "Armor made of interlocking metal rings.", 55, 75, "gp",
                                                16,
                                                ArmorType.HEAVY, false));

                this.getEquipment()
                                .add(new Weapon("Light Crossbow", "A small, one-handed crossbow.", 5, 25, "gp",
                                                new int[] { 1, 8 },
                ...
                this.getEquipment()
                                .add(new Weapon("Light Hammer", "A light throwing hammer.", 2, 2, "gp",
                                                new int[] { 1, 4 },
                                                Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.BLUDGEONING,
                                                "Light, Thrown (20/60)"));
                ...
                this.getEquipment()
                                .add(new Weapon("Spear", "A simple, versatile weapon.", 3, 1, "gp", new int[] { 1, 6 },
                                                Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.PIERCING,
                                                "Thrown (20/60), Versatile (1d8)"));
                ...
                this.getEquipment()
                                .add(new Weapon("Crossbow, Light", "A small, one-handed crossbow.", 5, 25, "gp",
                                                new int[] { 1, 8 },
                                                Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.PIERCING,
                                                "Ammunition (range 80/320), Loading, Two-handed"));
                ...
                this.getEquipment().add(
                                new Weapon("Shortbow", "A small bow suitable for short-range attacks.", 2, 25, "gp",
                                                new int[] { 1, 6 },
                                                Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.PIERCING,
                                                "Ammunition (range 80/320), Two-handed"));
        ...
        void Druid() {
                ...
                this.getEquipment()
                                .add(new Weapon("Scimitar", "A curved, slashing blade.", 3, 25, "gp",
                                                new int[] { 1, 6 },
        ...
        void Fighter() {
                ...
                this.getEquipment().add(new Weapon("Longbow",
                                ...
                                2, 50, "gp", new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_RANGE,
                                Weapon.AttackType.PIERCING,
                ...
                this.getEquipment().add(new Weapon("Flail", "A spiked chain with a heavy ball at the end.", 2, 10, "gp",
                                ...
                                ""));
                this.getEquipment()
                                .add(new Weapon("Glaive", "A long-handled weapon with a single-edged blade at the end.",
                                                6, 20, "gp",
                                                new int[] { 1, 10 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.SLASHING,
                ...
                this.getEquipment()
                                .add(new Weapon("Greatsword", "A large, two-handed sword with a sharp blade.", 6, 50,
                                                "gp",
                                                new int[] { 2, 6 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.SLASHING, "Heavy, Two-handed"));

                this.getEquipment()
                                .add(new Weapon("Halberd", "A long-handled weapon with an axe blade and a spear point.",
                                                6, 20, "gp",
                                                new int[] { 1, 10 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.SLASHING,
                                                "Heavy, Reach, Two-handed"));
                ...
                this.getEquipment()
                                .add(new Weapon("Lance", "A long, narrow weapon used for mounted combat.", 6, 10, "gp",
                                                new int[] { 1, 12 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.PIERCING, "Reach, Special"));

                this.getEquipment()
                                .add(new Weapon("Longsword", "A versatile and balanced weapon with a sharp blade.", 3,
                                                15, "gp",
                                                new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.SLASHING, "Versatile (1d10)"));
                ...
                this.getEquipment()
                                .add(new Weapon("Morningstar", "A spiked weapon with a heavy, blunt head.", 4, 15, "gp",
                                                new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.PIERCING, ""));
                this.getEquipment()
                                .add(new Weapon("Pike", "A long, pointed polearm with a sharp tip.", 18, 5, "gp",
                                                new int[] { 1, 10 },
                                                Weapon.WeaponType.MARTIAL_MELEE, Weapon.AttackType.PIERCING,
                                                "Heavy, Reach, Two-handed"));

                this.getEquipment()
                                .add(new Weapon("Rapier", "A slender, piercing weapon with a sharp point.", 2, 25, "gp",
                                                new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.PIERCING, "Finesse"));

                this.getEquipment().add(new Weapon("Scimitar", "A curved, slashing blade.", 3, 25, "gp",
                                new int[] { 1, 6 },
                                Weapon.WeaponType.MARTIAL_MELEE, Weapon.AttackType.SLASHING, "Finesse, Light"));

                this.getEquipment()
                                .add(new Weapon("Shortsword", "A simple, versatile weapon with a sharp blade.", 2, 10,
                                                "gp", new int[] { 1, 6 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.PIERCING, "Finesse, Light"));

                this.getEquipment()
                                .add(new Weapon("Trident", "A three-pronged spear designed for throwing.", 4, 5, "gp",
                                                new int[] { 1, 6 },
                                                Weapon.WeaponType.MARTIAL_MELEE, Weapon.AttackType.PIERCING,
                                                "Thrown (20/60), Versatile (1d8)"));
                ...
                this.getEquipment()
                                .add(new Weapon("Blowgun", "A small tube used for blowing darts at a target.", 1, 10,
                                                "gp",
                                                new int[] { 1 }, Weapon.WeaponType.MARTIAL_RANGE,
                                                Weapon.AttackType.PIERCING,
                                                "Ammunition (range 25/100), Loading"));

                this.getEquipment()
                                .add(new Weapon("Crossbow, Hand", "A small, one-handed crossbow.", 3, 75, "gp",
                                                new int[] { 1, 6 },
                                                Weapon.WeaponType.MARTIAL_RANGE, Weapon.AttackType.PIERCING,
                                                "Ammunition (range 30/120), Light, Loading"));

                this.getEquipment()
                                .add(new Weapon("Crossbow, Heavy", "A large, two-handed crossbow.", 18, 50, "gp",
                                                new int[] { 1, 10 },
                                                Weapon.WeaponType.MARTIAL_RANGE, Weapon.AttackType.PIERCING,
                ...
                this.getEquipment()
                                .add(new Weapon("Longbow", "A large bow suitable for long-range attacks.", 2, 50, "gp",
                                                new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_RANGE,
                                                Weapon.AttackType.PIERCING,
                                                "Ammunition (range 150/600), Heavy, Two-handed"));

                this.getEquipment()
                                .add(new Weapon("Net", "A mesh of woven ropes designed to restrain targets.", 3, 1,
                                                "gp", new int[] { 0 },
                                                Weapon.WeaponType.MARTIAL_RANGE, Weapon.AttackType.BLUDGEONING,
                                                "Special, Thrown (5/15)"));

                this.getEquipment()
                                .add(new Armor("Shield", "A protective piece of equipment worn on the arm.", 6, 10,
                                                "gp",
                ...
                this.getEquipment()
                                .add(new Weapon("Light Crossbow", "A small, one-handed crossbow.", 5, 25, "gp",
                                                ...
                                                "Ammunition (range 80/320), Loading, Two-handed"));
                this.getEquipment()
                                .add(new Misc("Bolts (20)",
                                                "A bundle of 20 projectiles designed for use with crossbows.", 1, 1,
                                                "gp"));

                this.getEquipment().add(new Weapon("Hand Axe's (2)", "A small, versatile axe.", 4, 10, "gp",
                                new int[] { 1, 6 },
        ...
        void Monk() {
                ...
                this.getEquipment()
                                .add(new Weapon("Dagger", "A small, easily concealable knife.", 1, 2, "gp",
                                                new int[] { 1, 4 },
                                                Weapon.WeaponType.SIMPLE_MELEE, Weapon.AttackType.PIERCING,
                                                "Finesse, Light, Thrown (20/60)"));
                ...
                this.getEquipment()
                                .add(new Weapon("Shortbow", "A small bow suitable for short-range attacks.", 2, 25,
                                                "gp",
                                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_RANGE,
                                                Weapon.AttackType.PIERCING,
                                                "Ammunition (range 80/320), Two-handed"));
                ...
                this.getEquipment()
                                .add(new Weapon("Sling", "A simple leather sling for hurling projectiles.", 0, 1, "sp",
                                                new int[] { 1, 4 },
                                                Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.BLUDGEONING,
                                                "Ammunition (range 30/120)"));
                ...
                this.getEquipmentGiven()
                                .add(new Misc("Dart (10)", "A set of 10 small, throwable projectiles.", 0, 5, "cp"));
        }

        void Paladin() {
                this.jobTitle = "paladin";
                setWis();
                setCha();
                setBaseHP(10);
                getProficiancy().set(0, "all armor, shields");
                ...
                this.getEquipment()
                                .add(new Weapon("Javelin's (5)", "A light spear designed for throwing.", 10, 50, "sp",
                                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_MELEE,
                                                Weapon.AttackType.PIERCING, "Thrown (30/120)"));
        ...
        void Ranger() {
                ...
                this.getEquipment()
                                .add(new Armor("Scale Mail", "Heavy armor made of interlocking metal scales.", 45, 50,
                                                "gp",
                                                14, ArmorType.HEAVY, true));

                this.getEquipment()
                                .add(new Armor("Leather Armor", "Light armor made from tanned animal hides.", 10, 10,
                                                "gp",
                ...
                this.getEquipmentGiven().add(new Weapon("Longbow",
                                "A powerful ranged weapon with great accuracy with 20 arrows.", 2, 50, "gp",
        ...
        void Rogue() {
                ...
                this.getEquipment()
                                .add(new Weapon("Rapier",
                                                "A slender, sharply-pointed sword suitable for thrusting attacks.", 2,
                                                25, "gp",
                                                new int[] { 1, 8 }, Weapon.WeaponType.MARTIAL_MELEE,
                                                Weapon.AttackType.PIERCING, "Finesse"));
                ...
                this.getEquipment().add(new Weapon("Shortbow",
                                "A small bow suitable for short-range attacks with 20 arrows.", 2, 25, "gp",
                                new int[] { 1, 6 }, Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.PIERCING,
                                "Ammunition (range 80/320), Two-handed"));
                ...
                this.getEquipmentGiven().add(new Weapon("Dagger", "A small, easily concealable knife.", 1, 2, "gp",
                                ...
                                "Finesse, Light, Thrown (20/60)"));
                this.getEquipmentGiven()
                                .add(new Misc("Thieves' Tools", "A set of tools for picking locks and disabling traps.",
                                                1, 25, "gp"));

        }

        void Sorcerer() {
                this.jobTitle = "sorcerer";
                setDex();
                setCon();
                setBaseHP(6);
                ...
                this.getEquipment().add(new Weapon("Light Crossbow", "A small, one-handed crossbow with 20 bolts.", 5,
                                25, "gp",
                                new int[] { 1, 8 }, Weapon.WeaponType.SIMPLE_RANGE, Weapon.AttackType.PIERCING,
                                "Ammunition (range 80/320), Loading, Two-handed"));
        ...
        void Warlock() {
                ...
                this.getEquipmentGiven()
                                .add(new Armor("Leather Armor", "Light, flexible armor made from animal hides.", 10, 10,
                                                "gp",
                                                11, ArmorType.LIGHT, false));
                this.getEquipmentGiven()
                                .add(new Weapon("Dagger", "A small, easily concealable knife.", 1, 2, "gp",
        ...
        void Wizard() {
                ...
                this.getEquipment().add(new Misc("Component Pouch",
                                "A small, watertight leather belt pouch containing various spell components.", 2, 25,
                                "gp"));
                ...
                this.getEquipmentGiven().add(new Misc("Spellbook",
                                "A book containing arcane symbols and formulas used by wizards to prepare their spells.",
                                3, 50, "gp"));
        }
}
